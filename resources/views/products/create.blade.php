            ...
            <div class="p-4 rounded" style="background-color: rgba(255, 255, 255, 0.75);">
                ...
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="product_price" name="product_price" class="form-control form-control-sm"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="product_description" name="product_description" class="form-control form-control-sm" rows="4"
